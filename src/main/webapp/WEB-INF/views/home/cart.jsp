				...
				<div class="row">
					<div class="col-lg-4">
						<div class="cart-buttons">
							<a href="shop" class="primary-btn up-cart">
							Tiếp Tục Mua hàng
							</a> <a href="/home/cart/clear" class="primary-btn up-cart"> Xóa giỏ hàng</a>
						</div>
					</div>
					<div class="col-lg-4 offset-lg-4">
						<div class="proceed-checkout">
							<ul>
								<li class="cart-total">Tổng Thành Tiền <span>${cart.total }</span></li>
							</ul>
							<c:if test="${!isLogin}">
								<a href="/home/login" class="proceed-btn">Thanh Toán</a>
							</c:if>
							<c:if test="${isLogin}">
								<a href="/home/checkout" class="proceed-btn">Thanh Toán</a>
							</c:if>
						</div>
					</div>
				</div>
