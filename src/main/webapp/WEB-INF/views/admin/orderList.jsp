				...
				<table class="table text-center">
					<thead>
						<tr>
							...
							<th style="font-weight: bolder; font-size: 18px">Tên người đặt</th>
							<th style="font-weight: bolder; font-size: 18px">Thời gian đặt</th>
							...
							<tr>
								...
								<td><a class='btn btn-danger btn-xs'
									style="font-size: 14px" href="order/delete/${item.id}"> <span
										class="glyphicon glyphicon-edit"></span> Xóa
								</a></td>
							</tr>
						</c:forEach>
					</tbody>
